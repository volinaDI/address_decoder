function chaoticAddressReplace(text){
    var dict = {
        ...
        "джавахарлала неру": /((з|дж)а(в[оа])?р?ха(рл?|р?л)а[вл]а|харлала) [мн][еи]ру/,
        "новобиккино": /(на ?баб[иe] ?кино|новолюбить ?кино)/,
        "яшьлек": /я[щш]и?л[еы]к/,
        "торайгырова": /(султан ?махму[дт]а? )?т[оау]райг[иы]р(о|з[еио])ва( султан ?махму[дт]а?)?/,
    ...
    _.keys(dict).forEach(function(elem) {
        ...
        text = text.replace(dict[elem], elem);
    });
    return text;
}